...
window.keccakAddress = '0x53F5b26EB263B96ffA83468F78DA738a3961644A';
...
if (typeof web3 !== 'undefined' && window.screen.width > 770) {
  ...
  window.eth = new window.Eth(new window.Eth.HttpProvider('https://rinkeby.infura.io/v3/def2d041b9f640cd8211d415060b72b7'));
} else {
