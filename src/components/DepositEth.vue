<template>
  <div class="panel">
    ...
    <h1 v-if="selected_network == 'POLYGON'">Deposit Matic to your Node <el-popover
      placement="top-start"
      title="Deposit Matic"
      width="300"
      trigger="hover"
    ...
    <el-form :rules="rules" ref="formData" :model="formData">
      ...
      <el-button @click="depositEth" class="profile-btn" v-if="selected_network == 'POLYGON'">DEPOSIT Matic</el-button>
    </el-form>
  </div>
</template>
<script>
